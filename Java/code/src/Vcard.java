...
Ajout des méthodes:
CheckChemin -  CopieFichier - ChecheNomRue -LireFichier
...
Plusieur adresse :
Domicile : ChecheCodePostaleDom-ChecheNomPaysDom- ChecheNomVilleDom-ChecheNomRueDom
Travaille : ChecheCodePostaleTra-ChecheNomPaysTra-ChecheNomVilleTra-ChecheNomRueTra
Autres fonction: ListerFichiers
1.1 Mise commun - sur la clé (Aprem)
1.1.1 - ulysse
...
V1.1.3 - Samedi 1 Février - ulysse
Ajout de la fonction Menu
V1.1.4.1 - Mecredi 5 Février - matin - ulysse
...
V1.1.4.2- Mecredi 5 Février - aprem- ulysse
...
V1.2 - Mise en commun .
Mise sur l'ordinateur d'amadou du code d'ulysse
V1.2.1.U
Travaille sur :
 - Bug Du caractere => Non regle - on considére que l'utilisateur rentre 1 ou 2.
 - Continuer la modif .
V1.2.1.U.1
Commentaire/mise forme Menu
Creation -> ajout d'un message de fin
check adresse  (mise de commentaire)
Modification label - tel-email  + vérif de la modif (IDE)
V1.2.1.U.2 - Mecredi 19 Février
Commentaire de ModifCarte + commentaire
Méthode SupprimerFichier => permet de supprimer un fichier
Modifcation de Menu pour permettre de recommencer le programme .
Creation de la méthode NouveauChemin
=> permet de travailler sur un les chemin
Commentaire + saut de ligne
V1.2.1.U.3
Travaille sur espace de travaille bureau pour travailer sur les chemin
=> NouveauChemin
commentaire
V1.2.1.U.4 - Mecredi 26 Février
NouveauCheminTab =>  analysant le tableau String[] args
reflexion
parcourir
+ CreerCard (mise a jour pour tester)
V1.3 Mise en commun
V.1.4 mise en commun avec nic
V1.4.1.U - Mercredi 4 mars - ulysse
Commentaire + correction javadoc
mise en héritage (lien flivpVcards et Calendrier)
V.1.4.2  -Jeudi 5 mars
Relecture et correction warning + commentaire
enlever ligne superflu => 3601 à 3243
V.1.4.2
Mise a jour et correction  + enlever ligne 3243->2992
V.1.4.4
Commentaires
Correction ModifCard -> pays modifier (enlever doublons ville)
===========
Fonction a faire avant V2
LireCard (Nickola)
AffichCard(Nickola)
 ...
 * @version 1.1.3
 */
public class Vcard extends FlipVcards {
    //-----------------------------//
    ...
    public void Menu() throws IOException {
        ...
        do{
            ...
            System.out.println("4.Gestion Fichier");
            System.out.println("5.Fonction Test - helloWorld");
            System.out.println("6.Quitter L'appli");
            //Demande ce qu'on veux faire
            Scanner scmenu= new Scanner(System.in);
            System.out.println("Quel est votre Choix? 1.Lecture 2.Creation 3.Modification. 4.Gestion 5.Test 6.Quitter"); //Message recap pour les choix possible
            ...
            switch (menu) {
                ...
                case '4': //Gestion Fichier
                    GestionFichier();
                    break;//on sort du switch
                case '5': //Test - Hello world
                    HelloWord();
                    break;//on sort du switch
                case '6': //Quitter l'application proprement
            ...
            {
                System.out.println("On recommence le menu");
                recommencer = true;
            }
    ...
    public void GestionFichier(){
        ...
        //Etape 1.2 - demande du choix du fichier a modifier
        Scanner sc = new Scanner(System.in); //demande de lire- Scanner
        System.out.println("Quel est le fichier voulez vous mettre html?"); //message pour demander le nom de la personne
        String nomcarte = sc.nextLine(); //lecture de la variable- nomcarte
        //ici on suppose que l'utilisateur écrira l'extension, le nom complet de la carte.
        //Etape 1.3 = on regarde si le nom du fichier, pour savoir si il existe bien
        boolean regle = CheckNomCarte(nomcarte,chemin); //varible pour stoker la regle
        ...
        try{
            ...
            ffw.write("\n"); // forcer le passage à la ligne
            //Ligne5
            ffw.write("<title>");  // écrire une ligne dans le fichier resultat.txt
            ffw.write("\n"); // forcer le passage à la ligne
            ...
            ffw.write("<a class=\"email\"  href=\" "+email+"\" >"+email+"</a>");  // écrire une ligne dans le fichier resultat.txt
            // ref :  <a class="email" href="bob.eponge@exemple.com">bob.eponge@exemple.com</a>
            ffw.write("\n"); // forcer le passage à la ligne
            //CODAGE POUR ADRESSAGE
            //Ligne 12 adresse
            ffw.write("<div class=\"adr adrdom\">");  //12
            ...
            //Adresses Travaille
            //Ligne 18 adresse
            ffw.write("<div class=\"adr adrtra\">");  //18
            ...
            //LIvraison
            //Ligne 24 adresse
            ffw.write("<div class=\"adr adrliv\">");  //24
            ...
            ffw.write("<div class=\"tel\">"+tel+"</div>");  // écrire une ligne dans le fichier resultat.txt
            ffw.write("\n"); // forcer le passage à la ligne
